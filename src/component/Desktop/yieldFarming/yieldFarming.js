  ...
  return (
    <Container className="Pool" id="Pool">
      ...
      <Content className={"sub " + (isOpen ? "" : "hide")}>
        ...
        <div className="amount" style={{ marginTop: "5px auto" }}>
        ...
        >
          <div>
            ...
            >
              {account && plIsApproved ? "Stake" : "Approve"}
            </span>
          </div>
        </StakeBtn>
        <TwoBtns>
          ...
          >
            <span className={account ? "" : "disable"}>Mine</span>
          </div>
          <div>
            <span
              onClick={UnStake}
